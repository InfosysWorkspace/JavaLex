...
/*
    Problem Statement
    Here is an example demonstrating the use of LocalDateTime Functions.
    Trainees are supposed to try other methods of LocalDateTime class
    with various scenarios.
*/
public class LocalDateTimeTryout {
    public static void main(String[] args) {

        /*
            Use LocalDateTime.format(DateTimeFormatter) method to format a
            local time to a desired string representation.
        */
		...
		*/
        ...
        DateTimeFormatter formatterNew = DateTimeFormatter.ofPattern("eee yyy-MMM-dd HH:mm:ss ");
